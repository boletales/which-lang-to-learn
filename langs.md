...
| 3 | C++ | 0.67 sec. |1.11x |
| 4 | C | 0.76 sec. |1.27x |
| 5 | Haskell | 0.76 sec. |1.27x |
| 6 | Julia | 0.83 sec. |1.39x |
| 7 | VB.net | 0.84 sec. |1.40x |
| 8 | C# | 0.84 sec. |1.41x |
| 9 | Crystal | 0.87 sec. |1.46x |
| 10 | JS | 0.90 sec. |1.50x |
| 11 | Java | 0.98 sec. |1.63x |
| 12 | Fortran | 1.23 sec. |2.05x |
| 13 | Python | 1.74 sec. |2.90x |
| 14 | OCaml | 2.05 sec. |3.43x |
| 15 | F# | 2.38 sec. |3.97x |
| 16 | R | 3.36 sec. |5.62x |
| 17 | Cython | 3.72 sec. |6.21x |
| 18 | PyPy | 4.47 sec. |7.46x |
| 19 | Ruby | 20.46 sec. |34.16x |
...
| 2 | C++ | 0.58 sec. |1.01x |
| 3 | Assembly | 0.60 sec. |1.04x |
| 4 | Haskell | 0.71 sec. |1.25x |
| 5 | C | 0.72 sec. |1.26x |
| 6 | Julia | 0.73 sec. |1.28x |
| 7 | VB.net | 0.76 sec. |1.34x |
| 8 | C# | 0.76 sec. |1.34x |
| 9 | Crystal | 0.82 sec. |1.43x |
| 10 | Java | 0.84 sec. |1.48x |
| 11 | JS | 0.86 sec. |1.50x |
| 12 | Fortran | 1.09 sec. |1.91x |
| 13 | Python | 1.64 sec. |2.87x |
| 14 | OCaml | 1.68 sec. |2.95x |
| 15 | F# | 2.19 sec. |3.83x |
| 16 | R | 2.51 sec. |4.40x |
| 17 | Cython | 3.80 sec. |6.64x |
| 18 | PyPy | 3.83 sec. |6.70x |
| 19 | Ruby | 20.17 sec. |35.26x |
